            ...
            {[
              ...
              <Link href={`/collections/${brand.id}`} key={index}>
                <motion.div
                  ...
                  className="bg-card border border-border p-8 rounded-3xl text-center group hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 h-full flex flex-col"
                >
