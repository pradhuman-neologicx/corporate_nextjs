...
export const baseMetadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://stylefab.co.in/logoNew.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description: 'StyleFab Private Limited is a diversified textile enterprise dedicated to creating premium fabric solutions for the global apparel industry.',
    creator: '@stylefab',
    images: ['https://stylefab.co.in/logoNew.png'],
  },
  robots: {
    index: true,
    follow: true,
  ...
  alternates: {
    canonical: 'https://stylefab.co.in',
  },
}
...
export const structuredData = {
  ...
  name: 'StyleFab Private Limited',
  url: 'https://stylefab.co.in',
  logo: 'https://stylefab.co.in/logoNew.png',
  description:
